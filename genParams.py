...
cellParams[5, 4] = 1/(24.0*14.0) # lifespan (days) -> https://pmc.ncbi.nlm.nih.gov/articles/PMC4489929/
...
cellParams[5, 5] = 1/(24.0*3.0)  # lifespan (days)
...
envParams[1] = 1.0 #5.0 # simulation duration (days)
