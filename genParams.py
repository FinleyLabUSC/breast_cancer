...
cellParams[6, 3] = 90.0  # migration speed um/hr |
...
cellParams[6, 4] = 90.0  # migration speed um/hr
...
cellParams[6, 5] = 90.0 # migration speed um/hr (assumed to be the same as other cells)
